...
public class TaskHis {
    ...
    public TaskHis(Integer id, Date createTime, Date updateTime, Date deleteTime, String taskType, String mqExchange, String mqRoutingKey, String requestBody, String status, String errorMsg) {
        this.id = id;
